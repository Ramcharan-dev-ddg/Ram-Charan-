<div align="center">
  ...
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=9370DB&center=true&vCenter=true&width=600&lines=Full-Stack+Web+Developer;B.Tech+Engineer;Digital+Marketer+%26+Brand+Sparker;Automation+Expert;Multi-Niche+Blogger" alt="Typing SVG" />
  
  <br />

  <img src="https://img.shields.io/badge/B.Tech-ECE-4B0082?style=for-the-badge&logo=proquest&logoColor=white" alt="Academic Badge" />
...
I am a **Full-Stack Web Developer**, **Digital Marketer**, and **Automation Expert** currently pursuing my B.Tech in Electronics and Communication Engineering. I bridge the gap between creative UI/UX design, scalable backend database architectures, and brand sparking.

My approach is rooted in a **product-first mindset**—I engineer custom solutions for clients, from robust e-commerce platforms to multi-niche blogging architectures. I specialize in modern JavaScript ecosystems (Next.js, React), utilize backend-as-a-service platforms like Supabase and Firebase, and leverage automation workflows to deliver secure, production-ready applications. 
...
| **Digital Marketing** | Intermediate | Brand sparking, SEO optimization, content scaling, growth workflows |
| **Automation & Deployment** | Intermediate | Zapier/custom workflow automation, CI/CD, Netlify/Vercel hosting pipelines |
...
**Freelance Full-Stack Developer & Automation Expert** | **Independent**
*2023 – Present*
Designing custom web applications, marketing funnels, and business automation solutions for clients.
...
*   Configure payment gateways (Razorpay) and deploy advanced automation pipelines for workflow efficiency.
*   `Next.js` `React` `Supabase` `Automation` `Tailwind CSS`

**Founder & Brand Sparker** | **InfoPVR**
*2024 – Present*
...
*   Managed the content strategy, digital marketing campaigns, and technical scaling for over 29+ published articles.
*   `HTML/CSS` `JavaScript` `Digital Marketing` `SEO`
...
| **Automation Workflow** | Streamlined client business processes through custom automation integrations. |
